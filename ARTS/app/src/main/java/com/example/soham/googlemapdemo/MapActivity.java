...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       /* for (int i = 0; i < View_between_station.bus_route_list.size(); i++) {
        ...
        /*for(int i=0;i<View_between_station.listarray.size();i++) {
            rows[i]=View_between_station.listarray.get(i);
            Toast.makeText(MapActivity.this, rows[i].toString(),0).show();
            //rows = View_between_station.listarray.toString().split(",");
        }*/
        /*
        rows = View_between_station.listarray.toString().split(",");
        //data.clear();
        for (int i = 0; i < rows.length; i++) {
            ...
            LatLng a1 = new LatLng(Float.parseFloat(cols[0]), Float.parseFloat(cols[1]));
            Log.d("data--------", cols[0] + "-------" + cols[1]);
            ...
            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(a1, 12));
        }*/
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.googlemapdemo/http/host/path")
        );
    ...
    // Add a marker in Sydney and move the camera
        ...
        /*String rows[] = View_between_station.result1.split("`");
...
*/
    ...
    public class map_data extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                SoapObject request = new SoapObject(MapActivity.NAMESPACE, METHOD_NAME2);
                ...
                HttpTransportSE androidHttpTransport = new HttpTransportSE(MapActivity.URL);
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(MapActivity.this, result.toString(), Toast.LENGTH_SHORT).show();
...
// Start downloading json data from Google Directions API
    ...
    public class map_data_user extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                SoapObject request = new SoapObject(MapActivity.NAMESPACE, METHOD_NAME3);
