...
/**
 * Created by 100HM on 14/04/2017.
 */

public class Update_pass extends Activity {

    public static String NAMESPACE=Login.NAMESPACE;
    public static String URL=Login.URL;

    public static String METHOD_NAME="save_change_forget_password";
    public static String SOAP_ACTION="http://tempuri.org/save_change_forget_password";
    ...
    public class update_new_pass extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(Update_pass.this);
        ...
        protected String doInBackground(Void... arg0) {
            ...
            try {
                ...
                request.addProperty("email", Forget_Pass.email.getText().toString());
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(Update_pass.this, result, Toast.LENGTH_LONG).show();
            ...
            Intent i1 = new Intent(Update_pass.this,Login.class);
            startActivity(i1);
