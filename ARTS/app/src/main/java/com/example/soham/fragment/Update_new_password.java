...
import com.example.soham.arts.Success_change_pass;
 ...
 */
public class Update_new_password extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.help_icon:
                ...
                Toast.makeText(Update_new_password.this,"ARTS",Toast.LENGTH_SHORT).show();
