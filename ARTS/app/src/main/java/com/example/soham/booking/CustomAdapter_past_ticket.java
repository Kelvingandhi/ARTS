...
/**
 * Created by 100HM on 23/05/2017.
 */
public class CustomAdapter_past_ticket extends BaseAdapter {
    ...
    ArrayList<past_booking.Ticket_Lists> rowitem;
    LayoutInflater inflter;
    public CustomAdapter_past_ticket(Context context, ArrayList<past_booking.Ticket_Lists> rowitem) {
